...
(function ($) {
    $.fn.inputfilter = function (options) {
        ...
        var keyLog = function (e, m) { if (!settings.actionLog) return; var r = "Charcode: " + e.which + " Char: " + String.fromCharCode(e.which) + (m.length != 0 ? " - " + m : ""); window.console && console.log(r);};
        return this.on("keypress change paste", function (e) {
            ...
            case "keypress":
                ...
                // Maxlength
                if (settings.maxLength != null && $(this).val().length >= settings.maxLength && window.getSelection().toString() == "") {
            ...
            default:
                ...
                setTimeout(function () {
                    ...
                    $($this).val(_output);
                    if (!settings.actionLog) return; var r = "Type: " + $type + " Regexp: " + _regexp + " Input: " + _input + " Output: " + _output; window.console && console.log(r);
                }, 0);
            }
        });
    };
