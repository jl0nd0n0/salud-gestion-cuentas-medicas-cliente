...
app.monitor = {
   index: function () {
        ...
        // Preparar datos antes de pasarlos al template
        ...
        const tableTemplate = `
            <div class="card mt-4 ml-5">
                ...
                <div class="d-flex align-items-center mb-3">
                    <input id="txtSearch" type="text" class="form-control" placeholder="Buscar ..." autocomplete="off" style="width: 780px; height: 36px;">
                    <select id="selectFilter" class="form-select" style="width: 200px; height: 36px;">
                        <option value="all">Mostrar todos</option>
                        <option value="ok">Radicar OK</option>
                        <option value="no">Radicar Pendientes</option>
                    </select>
                </div>
        ...
        const tableTemplate = `
            <div class="card mt-4 ml-5">
                ...
                <div class="card-body">
                    <select id="selectFilter" class="form-select mb-2" style="width: 200px;">
                        <option value="all">Mostrar todos</option>
                        <option value="ok">Radicar OK</option>
                        <option value="no">Radicar Pendientes</option>
                    </select>
                    ...
                    <div id="searchTarget">
                        <style>
                            .table-robot-armado-cuenta, .table-robot-armado-cuenta-detail {
                                table-layout: fixed;
                                width: 930px;
                            }
                            .table-robot-armado-cuenta-detail tr th {
                        ...
                        {{~it.detail: d:id}}
                        <div class="search-group mb-4" data-radicar="{{=d.radicarOK ? 'ok' : 'no'}}">
                            <table class="table table-bordered table-sm table-robot-armado-cuenta">
                                <colgroup><col width="50"><col width="350"><col width="200"><col width="140"><col width="240"></colgroup>
                                <thead class="table-primary">
                                    <tr>
                                        <th class="text-center">Radicar</th>
                                        <th class="text-center">Factura</th>
                            ...
                            <table class="table table-bordered table-sm table-robot-armado-cuenta-detail mb-3">
                                <colgroup><col width="400"><col width="200"><col width="140"><col width="120"><col width="120"></colgroup>
                                <thead class="table-primary">
                                    <tr>
                                        <th class="text-center">Grupo</th>
                                        <th class="text-center">Soporte</th>
